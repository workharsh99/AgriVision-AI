...
const translations = {
  ...
  es: {
    ...
    navDashboard: "Panel",
    navUpload: "Escanear Cultivo",
    navAIChat: "Chat con IA",
    navReports: "Historial",
    ...
    totalScans: "Informes Generados",
    cropsAnalyzed: "Cultivos Analizados",
    healthyCrops: "Cultivos Sanos",
    diseasedCrops: "Cultivos Enfermos",
    recentScans: "Escaneos Recientes",
    weatherAlerts: "Alertas Climáticas",
    cropCalendar: "Calendario de Cultivos",
    plantSowing: "Sugerencia de Siembra",
    plantHarvesting: "Ventana de Cosecha",
    voiceAssistant: "Asistente de Voz IA",
    speakNow: "Escuchando... Hable su pregunta sobre el cultivo.",
    clickToSpeak: "Haga clic para comando de voz",
    whyLeavesYellow: "¿Por qué se amarillean las hojas de mis cultivos?",
    bestFertilizerWheat: "¿Cuál es el mejor fertilizante para el trigo?",
    increaseRiceYield: "¿Cómo puedo aumentar el rendimiento del arroz?",
    dragDropText: "Arrastre y suelte la imagen de la hoja del cultivo aquí, o haga clic",
    supportedFormats: "Soporta JPG, PNG, JPEG, WEBP",
    analyzingImage: "La IA está diagnosticando su cultivo... Espere.",
    severity: "Severidad",
    confidence: "Puntaje de Confianza",
    symptoms: "Síntomas Detectados",
    causes: "Causas Posibles",
    treatment: "Plan de Tratamiento Inmediato",
    prevention: "Estrategia de Prevención a Largo Plazo",
    fertilizerRecs: "Recomendaciones de Fertilizantes",
    irrigationRecs: "Programación de Riego",
    pestControlRecs: "Control de Plagas y Enfermedades",
    yieldImprovement: "Consejos de Rendimiento",
    downloadPDF: "Descargar Informe PDF",
    emailReport: "Enviar Informe por Correo",
    smsReport: "Enviar Alerta por SMS",
    contactSupport: "Soporte Agrícola",
    send: "Enviar",
    language: "Idioma",
    ...
    location: "Ubicación",
    farmSize: "Tamaño (Acres)",
    preferredCrops: "Cultivos Preferidos",
  }
};
